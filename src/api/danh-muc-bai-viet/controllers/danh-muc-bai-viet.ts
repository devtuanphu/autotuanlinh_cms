/**
 * danh-muc-bai-viet controller
 */

import { factories } from '@strapi/strapi';

export default factories.createCoreController('api::danh-muc-bai-viet.danh-muc-bai-viet', ({ strapi }) => ({
  ...
  async getDanhMucCapHaiBySlug(ctx) {
    try {
      ...
      // Lấy tất cả danh mục bài viết sản phẩm (cấp 1) với danhMucCapHai
      ...
      for (const danhMuc of danhMucBaiViets) {
